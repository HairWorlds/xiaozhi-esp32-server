...
export default {
  ...
  "settings.validServerUrl":
    "请输入有效的服务端地址（以 http 或 https 开头，并以 /xiaozhi 结尾）",
  ...
  // 关于我们
  "settings.aboutApp": "关于小鹿智控台",
  "settings.aboutContent":
    "小鹿智控台\n\n基于 Vue.js 3 + uni-app 构建的跨平台移动端管理应用，为小鹿ESP32智能硬件提供设备管理、智能体配置等功能。\n\n© 2025 xiaozhi-esp32-server {version}",
  ...
  "settings.confirmClearMessage":
    "确定要清除所有缓存吗？这将删除所有数据包括登录状态，需要重新登录。",
  ...
  "message.invalidAddress":
    "地址可能无效，请检查服务端是否启动或网络连接是否正常；也可能因 HTTPS 协议问题导致无法发送请求",
