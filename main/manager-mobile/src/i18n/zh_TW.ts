...
export default {
  ...
  "manualAddDeviceDialog.invalidMacAddress":
    "請輸入正確的Mac地址格式，例如：00:1A:2B:3C:4D:5E",
  ...
  "settings.validServerUrl":
    "請輸入有效的服務端地址（以 http 或 https 開頭，並以 /xiaozhi 結尾）",
  ...
  // 關於我們
  "settings.aboutApp": "關於小鹿智控台",
  "settings.aboutContent":
    "小鹿智控台\n\n基於 Vue.js 3 + uni-app 構建的跨平台移動端管理應用，為小鹿ESP32智能硬體提供設備管理、智能體配置等功能。\n\n© 2025 xiaozhi-esp32-server {version}",
  ...
  "settings.confirmClearMessage":
    "確定要清除所有緩存嗎？這將刪除所有數據包括登錄狀態，需要重新登錄。",
  ...
  "message.invalidAddress":
    "地址可能無效，請檢查服務端是否啟動或網絡連接是否正常； 也可能因HTTPS協定問題導致無法發送請求常",
  ...
  "deviceConfig.connectToXiaozhiHotspot":
    "請先連接xiaozhi熱點 (xiaozhi-XXXXXX)",
  ...
  "deviceConfig.ensureWifiNetworkSelectedAndPasswordEntered":
    "確保已選擇WiFi網絡並輸入密碼",
  "deviceConfig.clickGenerateAndPlaySoundWave":
    "點擊生成並播放聲波，系統會將配網信息編碼為音頻",
  "deviceConfig.bringPhoneCloseToXiaozhiDevice":
    "將手機靠近xiaozhi設備（距離1-2米）",
  "deviceConfig.duringAudioPlaybackXiaozhiWillReceive":
    "音頻播放時，xiaozhi會接收並解碼配網信息",
  "deviceConfig.afterConfigSuccessDeviceWillConnect":
    "配網成功後設備會自動連接WiFi網絡",
  "deviceConfig.usesAfskModulation":
    "使用AFSK調制技術，通過1800Hz和1500Hz頻率傳輸數據",
